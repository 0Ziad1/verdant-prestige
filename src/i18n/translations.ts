  ...
  ar: {
    ...
    productData: {
      ...
      artisan: {
        ...
        fullDescription: '   أتحرص شركة جوفيرا علي انتاج الفريكة بمواصفات وجودة عالمية عن طريق اختيار اجود انواع القمح القاسي عالي الجودة حيث الزراعه بالطرق الصحيه لضمان سلامة الغذاء بالاسمدة العضوية خالي من المواد و الاسمدة الكيماوية لأنتاج غذاء صحي عالمي حيث اختيار مواعيد الزراعه والحصاد',
